...
// This is a hardcoded dictionary. In the future, this will get
// data from the SettingsViewController and we won't have to create
// it here.
...
+ (instancetype)shared {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSDictionary *businessDictionary = [[NSDictionary alloc] initWithObjectsAndKeys:@[@"cnbc.com", @"economist.com"], @"left",
                                                                                        ...
                                                                                        @[@"foxbusiness.com", @"washingtonexaminer.com"], @"right", nil];
